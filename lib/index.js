...
function Strategy(options, verify) {
  ...
  /* This function returns the username that will be used for the local profile.
     By default it does nothing, but it allows a degree of extensibility */
  this._mapUserName = function (username) {
    return username;
  };
}
...
Strategy.prototype.authenticate = function authenticate(req, options) {
  ...
  try {
    var username = this._mapUserName(req.headers[options.header_name]);
    if (username) {
